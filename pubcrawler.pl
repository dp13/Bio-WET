...
my $version_number = '$Revision: 2.16 $'; # '  $Date: 2010/07/03 08:24:49 $
...
my $PICS = $HTTPD . 'pics/';
my $link_gen = $HTML;
my $home_link = 'http://pubcrawler.gen.tcd.ie/10years.html';
...
$PARAM{'pic'} = $PICS . 'pubcrawler10.png';
my $alias_global = '';
...
my %checkbox_name = ('pubmed', '<INPUT TYPE="CHECKBOX" NAME="PubMedHits" VALUE=',
 ...
 # see http://www.ncbi.nlm.nih.gov/books/bv.fcgi?rid=helplinks.chapter.linkshelp for info on the next links:
my $summary_link = 'http://www.ncbi.nlm.nih.gov/sites/entrez?cmd=retrieve&dopt=Summary';
my $summary_link_pubmed = 'http://www.ncbi.nlm.nih.gov/pubmed/';
...
#		      'Queries', "${CGI}pubcrawler_buttons?submit=Modify+Queries&pc_name=$PARAM{'id'}",
		      ...
		      'News: 10 years old!', 'http://groups.google.com/group/pubcrawler-announcements',
		      );
    my  @user_links_order = ('FAQ', 'News: 10 years old!');
    my $user_links = '';
...
#		&update_output;
		...
		unless ($tmp_result =~ /<\/eSummaryResult>/si) {
		    ...
		    if ($PARAM{'quickstart'}) {
			$tmp_result .= "\n<CENTER><BIG><B>PubCrawler advises:</B>\n<B>-\&gt  <A HREF=\"${HTML}quickstart.html\">restart your jobs manually!</A></B></BIG></CENTER><BR>\n" ;
			$net_failure = 1;
			$advise = 1;
		    }
		} else {
...
Second author: Dr. Karsten Hokamp, khokamp@gmail.com
...
$Id: pubcrawler.pl,v 2.16 2010/07/03 08:24:49 pubcrawl Exp pubcrawl $
